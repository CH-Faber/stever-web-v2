...
import { getAllBotProfiles, getBotProfileById, createBotProfile, updateBotProfile, deleteBotProfile, validateBotProfile, } from '../services/botProfileService.js';
import { startBot, stopBot, getBotStatus, validateBotStartPrerequisites, } from '../services/processManagerService.js';
const router = Router();
/**
...
router.post('/', async (req, res) => {
    try {
        ...
        const validation = validateBotProfile(data);
        if (!validation.valid) {
            const details = {};
